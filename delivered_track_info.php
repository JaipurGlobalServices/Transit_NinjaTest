<?php
$title = 'Delivered Track Info';
$subTitle = 'Delivered Track Info';
...
{
    $sql = "SELECT DISTINCT $column FROM delivered_info";
...
$totalQuery = "SELECT COUNT(*) FROM delivered_info";
...
$sql = "SELECT tracking_id, shipment_partner, status, seller_name, contact_number, seller_mail, purchase_date, delivery_date, buyer_mail, order_id FROM delivered_info WHERE 1=1";
...
$totalRowsSql = "SELECT COUNT(*) as total FROM delivered_info WHERE 1=1";

// Apply filters and search term to the total count query as well
if ($statusFilter) {
...
<div class="card">
    <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-3">
        <div class="d-flex flex-wrap align-items-center gap-3">
            ...
            <form method="get" action="export-delivered.php" class="d-inline">
        ...
        <table class="table table-striped mb-0">
            <thead>
                <tr>
                    ...
                    <th scope="col">Shipment Partner</th>
            ...
            <tbody id="trackingInfoTable">
                <?php if ($result->num_rows > 0) {
                    ...
                    <tr>
                        <td colspan="10">No tracking information available</td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
