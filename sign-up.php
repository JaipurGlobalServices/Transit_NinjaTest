<?php
include 'config.php'; // Ensure this is included to access $conn
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Check if the $conn variable is set and working
    if ($conn) {
            ...
            <div class="max-w-464-px mx-auto w-100">
                ...
                <form method="post" action="">
                    <div class="icon-field mb-16">
                        ...
                        <input type="text" name="username" required class="form-control h-56-px bg-neutral-50 radius-12" placeholder="Username">
                    </div>
                    <div class="icon-field mb-16">
                        <span class="icon top-50 translate-middle-y">
                    ...
                    <button type="submit" value="Register" class="btn btn-primary text-sm btn-sm px-12 py-16 w-100 radius-12 mt-32"> Sign Up</button>
