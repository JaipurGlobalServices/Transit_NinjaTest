                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu to-top dropdown-menu-sm">
                        <div class="py-12 px-16 radius-8 bg-primary-50 mb-16 d-flex align-items-center justify-content-between gap-2">
                            <div>
                                <h6 class="text-lg text-primary-light fw-semibold mb-2"><?php echo ucwords(strtolower($_SESSION['username'])); ?></h6>
                                <span class="text-secondary-light fw-medium text-sm"><?php echo ucwords(strtolower($_SESSION['role'])); ?></span><br>
                                <span class="text-secondary-light fw-medium text-sm"><?php echo ucwords(strtolower($_SESSION['email'])); ?></span>
                            </div>
                        ...
                        <ul class="to-top-list">
                            ...
                            <li>
                                <a class="dropdown-item text-black px-0 py-8 hover-bg-transparent hover-text-danger d-flex align-items-center gap-3" href="sign-in.php" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
