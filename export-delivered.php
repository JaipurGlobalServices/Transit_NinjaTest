...
function fetchTrackingData($conn, $statusFilter, $shipmentPartnerFilter, $sellerNameFilter, $searchTerm) {
    ...
    $sql = "SELECT tracking_id, shipment_partner, status, seller_name, contact_number, seller_mail, buyer_mail, purchase_date, delivery_date, order_id FROM delivered_info WHERE 1=1";
    $conditions = [];
    $parameters = [];
