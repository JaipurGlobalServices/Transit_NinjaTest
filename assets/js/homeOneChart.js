...
// Assuming chartData is an array of raw counts like [500, 300, 200, 400]
var total = chartData.reduce(function (acc, val) {
  return acc + val;
}, 0);

// Convert each value to percentage
var percentageData = chartData.map(function (value) {
...
var options = {
  ...
  colors: [
    '#1E90FF', // DodgerBlue: Bright and stands out against black and white
    '#32CD32', // LimeGreen: Clear and bright
    '#FFD700', // Gold: Warm and visible
    '#FF6347', // Tomato: Bright and stands out
    '#D2691E', // Chocolate: Darker but still visible
    '#8A2BE2', // BlueViolet: High contrast on both backgrounds
    '#A52A2A', // Brown: Works well with both black and white
    '#FFFF00', // Yellow: Extremely bright and noticeable
    '#FF1493', // DeepPink: Vivid and stands out
    '#FF00FF', // Magenta: Clear on black or white background
    '#00FF7F'], // SpringGreen: Bright and visible, // Adjust colors as needed
  labels: chartLabels,
  legend: {
    show: true
  },
  ...
  tooltip: {
    y: {
      formatter: function (val, opts) {
        return chartData[opts.seriesIndex];
        // Show actual number on hover 
      }
    }
  },
  responsive: [{
